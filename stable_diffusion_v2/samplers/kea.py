...
class Sampler():
    def __init__(self, num_inference_steps=50, n_training_steps=1800, generator=None, beta_start=0.00085, beta_end=0.0120,):
    ...
    def step(self, latents, model_output, timestep=None):
        ...
        latents += model_output * (sigma_down - sigma_from)
        noise = torch.randn(
